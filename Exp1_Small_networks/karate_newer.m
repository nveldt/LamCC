...
h=text(place,.72,'\lambda*');
set(h,'Rotation',0,'color',lamcolor2,'fontsize',fsize);
...
print(gcf,sprintf(strcat('Figures/newerplot_',name,'.eps')),'-depsc2');
Process_AtendHeader(strcat('Figures/newerplot_',name,'.eps'),'');