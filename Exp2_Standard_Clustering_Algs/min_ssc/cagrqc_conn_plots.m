...
Bounds(end-15:end) = [1114, 1396,1610,1954.62,2444.75,3064.449,3580.458,3598.123,3358.94,2999.05,2585.05,2154.85,1701.9,1231.63,742.95,250.00];
...
plotname = strcat('Figures/caGrQc_cutoff.eps');
...
%
t = .4;
h = axes('Parent', gcf, 'Position', [p(1)+t p(2)+t p(3)-t p(4)-t]);
Bounds = LLs;
ms = 1;
lw = 1.5;
%figure(2)
...
xlim([1,19])
%box off
% legend('Graclus','Louvain','InfoMap','RMQC','RMC','Lambda-Louv')
% legend('Location','Best')
% legend boxoff
hold off
...
%%
set_figure_size([2.25*1.75,1.75*1.75]);
plotname = strcat('Figures/caGrQc_imposed.eps');
print(gcf,sprintf(plotname),'-depsc2');
Process_AtendHeader(plotname,'');
